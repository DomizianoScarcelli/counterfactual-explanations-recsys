...
def test_all_sync(model):
    ...
    """
    trace = torch.tensor([3430, 1371, 658, 595, 24, 339, 1238, 2572, 1232, 560, 247, 1250, 744, 1451, 2233, 1241, 961, 122, 986, 946]).unsqueeze(0)
    dataset = generate_counterfactual_dataset(trace, model)
