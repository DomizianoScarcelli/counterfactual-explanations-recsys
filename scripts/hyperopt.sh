...
fitness_alpha_options=(0.7 0.85)
generations_options=(10 20) #20 and 10 are the best
# pop_size_options=(2048 4096 8192 16384)
pop_size_options=(2048 8192) #2048 and 8192 seems better than other values. 8192 being better than all others.
...
total_iterations=$(( ${#crossover_prob_options[@]} * ${#mutation_prob_options[@]} * ${#fitness_alpha_options[@]} * ${#generations_options[@]} * ${#pop_size_options[@]} * ${#similarity_threshold_options[@]} * ${#genetic_topk_options[@]} * ${#num_mutations_options[@]}  ))
