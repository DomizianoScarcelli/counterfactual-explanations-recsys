...
total_iterations=$(( ${#crossover_prob_options[@]} * ${#mutation_prob_options[@]} * ${#fitness_alpha_options[@]} * ${#generations_options[@]} * ${#pop_size_options[@]} * ${#similarity_threshold_options[@]} * ${#genetic_topk_options[@]} * ${#num_mutations_options[@]} * ${#categorized_options[@]}))
...
EOF
                                ...
                                python -m cli evaluate automata_learning \
                                    --use-cache=False \
                                    --save-path="results/evaluate/automata_learning/automata_learning_hyperopt_untargeted.csv" \
